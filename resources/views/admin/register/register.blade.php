                                ...
                                <form class="form-body" action="{{ route('register') }}" method="post">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                                                <input type="password" name="confirmPassword" class="form-control radius-30 ps-5" id="inputChoosePassword" placeholder="Confirm Password">
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="d-grid">
                                                <input type="submit" class="btn btn-primary radius-30" value="Register">
                                            </div>
                                        </div>
                                        <div class="col-12">
