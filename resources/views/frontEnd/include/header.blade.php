                        ...
                        <ul class="main-menu text-right">
                            <li><a href="{{ route('/') }}">Home</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="{{ route('home-2') }}">Home Version Two</a></li>
                                    <li><a href="{{ route('home-3') }}">Home Box Layout</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="{{ route('job-board') }}">Pages</a>
                                <ul class="dropdown">
                                    <li><a href="{{ route('job-board') }}">Job Board</a></li>
                                    <li><a href="{{ route('single-job') }}">Single Job</a></li>
                                    <li><a href="{{ route('job-details') }}">Job Details</a></li>
                                    <li><a href="{{ route('job-details') }}candidates.html">Candidates</a></li>
                                    <li><a href="{{ route('job-details') }}resume.html">Resume</a></li>
