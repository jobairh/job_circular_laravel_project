        ...
        <div class="slider-area">
            <div class="preview-2">
                <div id="nivoslider" class="slides">
                    <img src="{{ asset('frontEndAsset') }}/images/slider/2.jpg" alt="" title="#slider-1-caption1"/>
                    <img src="{{ asset('frontEndAsset') }}/images/slider/1.jpg" alt="" title="#slider-1-caption2"/>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c1.png" alt="">
                            </div>
                            <div class="cat-text">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c2.png" alt="">
                            </div>
                            <div class="cat-text">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c3.png" alt="">
                            </div>
                            <div class="cat-text">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c4.png" alt="">
                            </div>
                            <div class="cat-text">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c5.png" alt="">
                            </div>
                            <div class="cat-text">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="category-item2">
                            <div class="img-icon">
                                <img src="{{ asset('frontEndAsset') }}/images/icons/h2c6.png" alt="">
                            </div>
                            <div class="cat-text">
